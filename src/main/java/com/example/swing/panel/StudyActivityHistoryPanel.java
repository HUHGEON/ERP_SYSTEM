...
public class StudyActivityHistoryPanel extends JPanel {
    ...
    private final JTextField studyField = new JTextField(15);
    private List<StudyActivityHistory> currentList;

    public StudyActivityHistoryPanel() {
        ...
        table.getColumnModel().getColumn(0).setPreferredWidth(120);  // 스터디명
        table.getColumnModel().getColumn(1).setPreferredWidth(90);   // 활동일자
        table.getColumnModel().getColumn(2).setPreferredWidth(200);  // 내용
    ...
    private void openDialog(StudyActivityHistory h) {
        JFrame frame = (JFrame) SwingUtilities.getWindowAncestor(this);
        StudyActivityHistoryDialog dialog = new StudyActivityHistoryDialog(frame, h, dao);
    ...
    private void deleteSelected() {
        ...
        StudyActivityHistory h = currentList.get(table.convertRowIndexToModel(row));
        if (JOptionPane.showConfirmDialog(this, "해당 스터디 활동 기록을 삭제하시겠습니까?",
