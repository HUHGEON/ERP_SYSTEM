...
public class OutputPanel extends JPanel {
    ...
    public OutputPanel() {
        ...
        table.getColumnModel().getColumn(2).setPreferredWidth(90);   // 산출물 유형
        table.getColumnModel().getColumn(3).setPreferredWidth(150);  // 산출물명
    ...
    private void deleteSelected() {
        ...
        Output o = currentList.get(table.convertRowIndexToModel(row));
