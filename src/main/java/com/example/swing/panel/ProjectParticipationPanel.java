...
public class ProjectParticipationPanel extends JPanel {
    ...
    public ProjectParticipationPanel() {
        ...
        table.getColumnModel().getColumn(1).setPreferredWidth(150);  // 프로젝트명
        table.getColumnModel().getColumn(2).setPreferredWidth(90);   // 개발자명
        table.getColumnModel().getColumn(3).setPreferredWidth(80);   // 역할
        table.getColumnModel().getColumn(4).setPreferredWidth(90);   // 투입일
        table.getColumnModel().getColumn(5).setPreferredWidth(90);   // 종료일
    ...
    private void deleteSelected() {
        ...
        ProjectParticipation pp = currentList.get(table.convertRowIndexToModel(row));
